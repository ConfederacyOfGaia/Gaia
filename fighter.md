...
Alternately, you can choose to forgo the ability score increase and take a Feat instead.
...
**Maneuvers.** You learn three maneuvers from the maneuver list. Many maneuvers enhance an attack in some way. You can use only one maneuver per attack. 

**Superiority Dice.** You have four superiority dice, which are d8s. A superiority die is expended when you use it. You regain all of your expended superiority dice when you finish a short or long rest.  You gain another superiority die at 7th level and one more at 15th level.

**Saving Throws.** Some of your maneuvers require your target to make a saving throw to resist the maneuver’s effects. The saving throw DC is 8+ your proficiency bonus + your Strength or Dexterity modifier (your choice).
...
Starting at 7th level, if you spend at least 1 minute observing or interating with another creature outside comnat, you can learn certain information about its capabilities compared to your own.  The DM tells you if the creature is your equal, superior, or inferior in regard to two of the following charactistics of your choice:  
...
* Armor Class
* Current hit points
* Total class levels (if applicable)
* Fighter class levels (if applicable)

\page

#### Improved Combat Superiority

At 10th level, your superiority die turn into d10s.  At 18th level, they turn into d12s.

#### Relentless

Starting at 15th level, when you roll initiative and have no superority dice remaining, you regain one superiority die.
...
**Maneuvering Attack.** When you hit a creature with a weapon attack, you can expend one superiority die to maneuver one of your com rades into a more advantageous position. You add the superiority die to the attack’s damage roll, and you choose a friendly creature who can see or hear you. That creature can use its reaction to move up to half its speed without provoking opportunity attacks from the target of your attack.
...
**Sweeping Attack.** When you hit a creature with a melee weapon attack, you can expend one superiority die to attempt to damage another creature with the same attack. Choose another creature within 5 feet of the original target and within your reach. If the original attack roll w ould hit the second creature, it takes damage equal to the number you roll on your superiority die. The damage is of the same type dealt by the original attack.
...
At 7th level, you gain additional benefits when you use superiority dice to increase your damage when you attack with a lance or spear. You can expend up to two superiority dice on the attack, adding both to the damage roll. If you spend two dice, the target has disadvantage on its Strength saving throw to avoid being knocked prone.
...
Mounted Archers are one of the specialities of Kylven fighters, who are born in the saddle and ride their whole lives.

#### Restriction: Archery Style

In order to choose this archetype at 3rd level, you have to have taken the Archery fighting style at 1st level.  Longbows are too large to use while mounted, so the Mounted Archer uses a shortbow.
...
**Using Surpiority Dice.** You can expend superiority dice to gain a number of different benefits:

* When you make a check to influence or control a creature you are riding, you can expend one superiority die to add it to the check. You apply this bonus after making the check but before learning if it was successful.
* When you make a ranged weapon attack against a creature, you can expend one superiority die to add it to the attack roll. You can use this ability before or after making the attack roll, but before any of the effects of the attack are applied.
* When you make a ranged attack while mounted, you can expend one superiority die to add it to your damage roll. In addition, the target of the attack must make a Strength saving throw (DC 8 + your proficiency bonus + your Strength modifier) or be knocked prone.
* If either you or your mount is hit by an attack while you are mounted, you can expend one superiority die as a reaction, adding the number rolled to your or your mount’s AC. If the attack still hits, you or your mount take half damage from it.

#### Sniper

At 6th level, learn a specific type of patient, aimed attack that is specific to Kylven Mounted Archer.  The archer approaches on his mount, using his action to aim carefully at a chosen target while closing the distance, and on the next round the attack is made with advantage.  If the attack hits, add your proficiency bonus to the damage roll.
...
* You have advantage on your attacks against that creature.
